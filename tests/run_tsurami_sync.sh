...
"$HOST_COMPILER" "${TEST_FLAGS[@]}" -DANCHOR_TSURAMI_DAMAGE_HOST_TEST \
    ...
    -c src/bosses/tsurami/anchor_tsurami_damage.c -o "$TEST_DIR/reflection_damage.o"
...
"$HOST_COMPILER" "${TEST_FLAGS[@]}" tests/test_tsurami_codec.c \
    src/bosses/tsurami/anchor_tsurami_codec.c -o "$TEST_DIR/codec"
"$TEST_DIR/codec"
"$HOST_COMPILER" "${TEST_FLAGS[@]}" -DANCHOR_TSURAMI_SYNC_HOST_TEST \
    tests/test_tsurami_sync.c src/bosses/tsurami/anchor_tsurami_sync.c \
    src/bosses/tsurami/anchor_tsurami_codec.c -o "$TEST_DIR/sync"
"$TEST_DIR/sync"
