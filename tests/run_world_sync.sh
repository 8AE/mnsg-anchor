...
"${HOST_CC:-cc}" -std=c99 -Wall -Wextra -Werror -Wno-misleading-indentation \
    ...
    -Iinclude tests/test_world_native.c src/world/anchor_world_codec.c \
    src/utils/string_utils.c -lm -o "$WORLD_TEST_DIR/native"
"$WORLD_TEST_DIR/native"
"${HOST_CC:-cc}" -std=c99 -Wall -Wextra -Werror -Wno-misleading-indentation \
    -O2 -ffast-math -fno-unsafe-math-optimizations -fsanitize=undefined \
    -Iinclude tests/test_world_dynamic_native.c src/world/anchor_world_dynamic_codec.c \
    src/utils/string_utils.c -lm -o "$WORLD_TEST_DIR/children"
"$WORLD_TEST_DIR/children"
"${HOST_CC:-cc}" -std=c99 -Wall -Wextra -Werror -Wno-misleading-indentation \
    -O2 -ffast-math -fno-unsafe-math-optimizations -fsanitize=undefined \
    -Iinclude tests/test_world_quest_native.c -o "$WORLD_TEST_DIR/quest"
"$WORLD_TEST_DIR/quest"
"${HOST_CC:-cc}" -std=c99 -Wall -Wextra -Werror -Wno-misleading-indentation \
    -O2 -ffast-math -fno-unsafe-math-optimizations -fsanitize=undefined \
    -Iinclude tests/test_world_bomb_native.c src/world/anchor_world_dynamic_codec.c \
    src/utils/string_utils.c -lm -o "$WORLD_TEST_DIR/bomb"
"$WORLD_TEST_DIR/bomb"
"${HOST_CC:-cc}" -std=c99 -Wall -Wextra -Werror -Wno-misleading-indentation \
    -O2 -ffast-math -fno-unsafe-math-optimizations -fsanitize=undefined \
    -Iinclude tests/test_world_crane_native.c src/world/anchor_world_codec.c \
    src/utils/string_utils.c -lm -o "$WORLD_TEST_DIR/crane"
"$WORLD_TEST_DIR/crane"
"${HOST_CC:-cc}" -std=c99 -Wall -Wextra -Werror -Wno-misleading-indentation \
    -O2 -ffast-math -fno-unsafe-math-optimizations -fsanitize=undefined \
    -Iinclude tests/test_world_bridge_native.c src/world/anchor_world_codec.c \
    src/utils/string_utils.c -lm -o "$WORLD_TEST_DIR/bridge"
"$WORLD_TEST_DIR/bridge"
"${HOST_CC:-cc}" -std=c99 -Wall -Wextra -Werror -Wno-misleading-indentation \
    -O2 -ffast-math -fno-unsafe-math-optimizations -fsanitize=undefined \
    -Iinclude tests/test_world_gate64_native.c src/world/anchor_world_codec.c \
    src/utils/string_utils.c -lm -o "$WORLD_TEST_DIR/gate64"
"$WORLD_TEST_DIR/gate64"
"${HOST_CC:-cc}" -std=c99 -Wall -Wextra -Werror -Wno-misleading-indentation \
    -O2 -ffast-math -fno-unsafe-math-optimizations -fsanitize=undefined \
    -Iinclude tests/test_world_doll_native.c src/world/anchor_world_codec.c \
