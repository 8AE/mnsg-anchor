...
static const AnchorFlagEntry s_entries[] = {
    ...
    {"fl_congo_killed", "Congo Defeated (Kill State)", 0},
    ...
    {"fl_cucumber", "Quality Cucumber Received", 0},
    {"fl_silver_wpn", "Silver Weapons Upgrade", 0},
    {"fl_si_train", "Sudden Impact Training", 0},
    {"fl_sj_train", "Super Jump Training", 0},
    {"fl_train_rej", "Priest Training Rejected", 0},
    {"fl_mini_rej", "Mini Ebisumaru Rejected", 0},
    {"fl_si_plasma", "Sudden Impact from Plasma", 0},
    {"fl_crack_door", "Saw the Cracked Door", 0},
    {"fl_plasma_sil", "Plasma: Silver Weapons Hint", 0},
    {"fl_plasma_swpn", "Plasma: Silver Weapons Granted", 0},
    {"fl_plasma_fv", "Plasma: Festival Village Hint", 0},
    {"fl_plasma_keg", "Plasma: Waterfall Kegon Hint", 0},
    {"fl_plasma_snow", "Plasma: Asks Benkei About Snow", 0},
    {"fl_plasma_end", "Plasma: No More Advice", 0},
    {"fl_son_cuke", "Priest's Son: No Cucumber", 0},
    {"fl_omitsu_wm", "Omitsu: Wise Man Hint", 0},
    {"fl_lost_benkei", "Lost to Benkei", 0},
    {"fl_witch_sec", "Sasuke Secret from the Witch", 0},
    {"fl_goemon_mg", "Goemon Mini-game Started", 0},
    {"fl_miniebi_mg", "Mini Ebisumaru Mini-game Started", 0},
    ...
    {0, "Surprise Packs", 0},
    {"sp_gh_false", "Surprise Pack: Ghost Toys False Floor", 0},
    {"sp_ft_tank", "Surprise Pack: Festival Temple Tank Hallway", 0},
    {"sp_gs_blast", "Surprise Pack: Gourmet Sub Blaster Crab", 0},
    {"sp_gs_jet", "Surprise Pack: Gourmet Sub Jetpack Crab", 0},
    {"sp_mc_aqua", "Surprise Pack: Musical Big Aquarium", 0},
    {"sp_yamato", "Surprise Pack: Yamato Shrine", 0},
    {"sp_awaji", "Surprise Pack: Kii-Awaji", 0},
    {"sp_jp_sea", "Surprise Pack: Japan Sea Underwater", 0},

    /* ── Mr. Elly Fant & Mr. Arrow packed bits ───────────────────────── */
    {0, "Mr. Elly Fant & Mr. Arrow", 0},
    {"me_oedo", "Mr. Elly Fant: Oedo Castle", 0},
    {"me_ghost", "Mr. Elly Fant: Ghost Toys", 0},
    {"me_fest", "Mr. Elly Fant: Festival Temple", 0},
    {"me_gour", "Mr. Elly Fant: Gourmet Sub", 0},
    {"me_music", "Mr. Elly Fant: Musical Castle", 0},
    {"ma_oedo", "Mr. Arrow: Oedo Castle", 0},
    {"ma_ghost", "Mr. Arrow: Ghost Toys", 0},
    {"ma_fest", "Mr. Arrow: Festival Temple", 0},
    {"ma_gour", "Mr. Arrow: Gourmet Sub", 0},
    {"ma_music", "Mr. Arrow: Musical Castle", 0},
    ...
    {"fl_mtfuji", "Visited Mt. Fuji", 0},
    {"fl_turtle_ryo", "Turtle Shrine Ryo", 0},
    {"fl_turtle_doll", "Turtle Shrine Doll Spawn", 0},
    ...
    {"wl_iyo", "Wall: Iyo", 0},
    {"wl_unk198", "Wall: Unidentified 0x198", 0},
    {"dr_19a", "Door State 0x19A", 0},
    {"dr_19b", "Door State 0x19B", 0},
    {"wl_ghost", "Wall: Ghost Toys Entrance", 0},
    {"sw_shore", "Switch: Japan Shoreline", 0},
    {"dr_19e", "Door State 0x19E", 0},
    {"fl_shuhudo", "Shuhudo Tunnel Blown", 0},
    {"fl_oc_gate", "Oedo Town Guards Opened Gate", 0},
    {"fl_imp_zazen", "Talked to the Imp in Zazen", 0},
    {"fl_sas_train", "Sasuke's Training Started", 0},
    {"fl_witch_house", "Entered the Witch's House", 0},
    {"fl_witch_cs_a", "Witch Cutscene 0x085", 0},
    {"fl_witch_cs_b", "Witch Cutscene 0x086", 0},
    {"fl_witch_cs_c", "Witch Cutscene 0x087", 0},
    {"fl_mtfear", "Mt. Fear Rock Destroyed", 0},
    {"fl_izumo_bat", "Battery Spawned at Izumo Tree", 0},

    /* ── Live encounter state ─────────────────────────────────────────── */
    {0, "Encounter State", 0},
    {"fl_congo_fight", "Fighting Congo", 0},
    {"fl_congo_door", "Congo Door Locked", 0},
    {"fl_congo_live", "Currently Fighting Congo", 0},
    {"fl_congo_f2", "Fighting Congo (0x26 b0)", 0},
    {"fl_congo_f3", "Fighting Congo (0x26 b1)", 0},
    {"fl_congo_f7", "Fighting Congo (0x26 b7)", 0},
    {"cr_not_play", "Ghost Toys: Not Playing Claw Game", 0},
    {"cr_playing", "Ghost Toys: Playing Claw Game", 0},
    {"cr_pick1", "Ghost Toys: Claw Picked Up (1)", 0},
    {"cr_pick2", "Ghost Toys: Claw Picked Up (2)", 0},
    {"ft_boss_spawn", "Festival Temple Boss Spawned", 0},
    {"dhrm_item", "Dharumanyo Miracle Item Taken", 0},
    {"dhrm_heart", "Dharumanyo Heart Exposed", 0},
    {"gt_boss_lock", "Ghost Toys Boss Room Diamond Lock", 0},
