...
#include "progression/anchor_miracle_moon.h"
...
static SyncFlagBit s_flag_bits[] = {
    ...
    /* File68's later continuation sets each fish flag whether or not its
       gated, capped color count increased. 0xB9 and 0xBB are listed below. */
    {0x0A7, 0, "fl_fish_a7"},
    {0x0A8, 0, "fl_fish_a8"},
    {0x0A9, 0, "fl_fish_a9"},
    {0x0AA, 0, "fl_fish_aa"},
    ...
    /* Cat Eyes rewards are quest progression despite being bought. Share
     * their durable flags without synthesizing a Doll count increment;
     * existing counter sync carries native count changes, if any. */
    {0x1C5, 0, "fl_ce_dharma"},
    {0x1C6, 0, "fl_ce_notice"},
    {0x1C7, 0, "fl_ce_doll"},
