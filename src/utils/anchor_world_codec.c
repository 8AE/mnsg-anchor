...
int anchor_world_row_valid(const int *r) {
  ...
  static const int hi[ANCHOR_WORLD_WORDS] = {
      255,    2047,  4,          1,       3276700, 3276700, 3276700, 1023,
      1023,   1023,  255,        1000000, 65535,   7,       100000,  100000,
      100000, 32767, 0x7fffffff, 32767,   32767,   32767,   32767,   32767,
      32767,  32767, 64000,      64000,   64000,   3,       163,     32767,
      7,      255,   32767,      32767,   32767,   255,     1};
  unsigned int i;
